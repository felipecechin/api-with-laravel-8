            ...
            <div class="col-md-8">
                <card-component titulo="Busca de marcas">
                    ...
                    <template v-slot:rodape>
                        <button type="submit" class="btn btn-primary btn-sm float-end" @click="pesquisar()">Pesquisar
                        </button>
                    </template>
                </card-component>
            ...
            <template v-slot:conteudo>
                ...
                <div class="form-group">
                    <input-container-component titulo="Imagem" id="atualizarImagem" id-help="atualizarImagemHelp" texto-ajuda="Selecione uma imagem no formato PNG">
                        <input type="file" class="form-control-file" id="atualizarImagem" ref="atualizarImagem" aria-describedby="atualizarImagemHelp" placeholder="Selecione uma imagem" @change="carregarImagem($event)">
                    </input-container-component>
                </div>
            </template>
        ...
        atualizar() {
            ...
            axios.post(url, formData, config)
                .then(response => {
                    ...
                    this.$refs.atualizarImagem.value = ''
                    this.carregarLista()
                })
                .catch(errors => {
